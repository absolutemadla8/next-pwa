...
const BottomOrderInfo = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center rounded-lg overflow-hidden w-full max-w-screen-xl mx-auto'>
    <div className='flex flex-row items-center justify-between w-full px-3 py-2'>
      ...
      <h2 className='text-md text-white' style={{ fontFamily: 'var(--font-nohemi)' }}>
        {infoSubtitle}
      </h2>
    ...
    {infoTitle}
            ...
            className='flex flex-row items-center justify-start font-normal text-white w-[40%] p-0'
            >
                {buttonText}
            </AnimatedButton>
    </div>
